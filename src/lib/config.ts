...
export const APP_CONFIG = {
  appName: "Stripe Payment Hub",             // Display name (sidebar header, page title)
  projectName: "Payment Integration",        // Client's product name (tab bar microtext, footer)
  clientName: null as string | null,         // Client first name, or null — never render "null"
  domain: "finance",                         // Domain (finance, health, marketplace, tech, etc.)
