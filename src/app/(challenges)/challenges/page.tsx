...
export const metadata = { title: "My Approach | Stripe Payment Hub" };
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 md:px-6 space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            How I would tackle the key technical challenges in this Stripe
            integration
          </p>
        </div>

        {/* Executive summary — dark hero banner with back-link */}
        <ExecutiveSummary
